...
This repository is based on the original work by Daniil Osokin:
https://github.com/Daniil-Osokin/lightweight-human-pose-estimation.pytorch

The original license is preserved in [LICENSE](LICENSE) (Apache License 2.0).
This team version includes additional demo and visualization adjustments for internal use.
